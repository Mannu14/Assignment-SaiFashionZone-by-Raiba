...
const sendConfirmationEmail = async (email, complaintNumber, message) => {
  try {
    const mailOptions = {
      from: '"SaiFashionZone by Raiba" <pecommerce8@gmail.com>',
      to: email,
      ...
      html: `
        <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e1e1e1; border-radius: 10px; background-color: #ffffff;">
          ...
          <div style="background-color: #ffb6c1; padding: 15px; border-radius: 10px 10px 0 0; text-align: center;">
            <h1 style="font-family: 'Brush Script MT', cursive; color: #ffffff; font-size: 36px; margin: 0;">SaiFashionZone by Raiba</h1>
          </div>
      ...
      const emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background-color: pink; padding: 20px; text-align: center; margin-bottom: 20px;">
            <h1 style="color: #333; margin: 0;">SaiFashionZone by Raiba</h1>
          </div>
          ...
          <p style="margin-top: 30px;">Best regards,<br>Your SaiFashionZone by Raiba Team</p>
        </div>
      `;

      await transporter.sendMail({
        from: '"SaiFashionZone by Raiba Support" <pecommerce8@gmail.com>',
