    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-600">Order Details</h2>
          <button 
            onClick={onClose} 
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-xl font-bold text-gray-600">${order.price}</p>
          </div>
        </div>
      </div>
    </div>
...
const Orders = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch(`${window.location.origin}/get-orders`);
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-8 ml-[5rem] lg:ml-64 bg-gray-50 min-h-screen">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-700 mb-4">Order Management</h1>
          <div className="w-full max-w-md mx-auto">
            <div className="relative">
              <input
                type="text"
                placeholder="Search by order ID or customer name..."
                className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300"
                value={searchQuery}
