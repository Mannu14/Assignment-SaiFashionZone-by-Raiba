...
const ScrollProgress = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 left-0 h-1 bg-gradient-to-r from-gray-500 to-blue-500 origin-left z-50"
      initial={{ scaleX: 0 }}
      ...
      <div className="w-full bg-white overflow-hidden">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          >
            <div className="bg-white/20 backdrop-blur-md border border-white/30 p-12 md:p-16 rounded-3xl shadow-2xl text-center">
              <h1 className="mb-6 text-5xl md:text-6xl font-extrabold text-white tracking-tight bg-clip-text bg-gradient-to-r from-gray-500 to-blue-500 text-transparent">
              ...
              <div className="space-x-4 flex justify-center">
                ...
                <Link to="/shop">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-gray-500 to-blue-500 text-white hover:opacity-90 px-10 py-3 rounded-full uppercase text-sm tracking-wider font-semibold shadow-xl transition-all"
                  >
                    Shop Now
                  </motion.button>
                </Link>
        ...
        <section className="px-4 py-20 bg-gray-50">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <h2 className="text-4xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-blue-500">
                Our Collections
              </h2>
              <div className="w-24 h-1 bg-gradient-to-r from-gray-500 to-blue-500 mx-auto mb-6"></div>
            ...
            >
              {productCategories.map((category, index) => (
                <Link to='/shop' key={index}>
                  <motion.div
                    className="bg-white rounded-1xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group transform hover:-translate-y-4"
                    variants={{
                  ...
                  >
                    ...
                    <div className="p-6 text-center bg-white">
                      <h3 className="text-2xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-blue-500">
                        {category.title}
                      </h3>
        ...
        <section className="relative min-h-[80vh] flex items-center" data-aos="fade-up">
          ...
          <div className="container relative z-10 mx-auto max-w-6xl px-4">
            <motion.div
              ...
              transition={{ duration: 1, ease: "easeOut" }}
            >
              <h2 className="text-5xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-blue-500">
                Our Vision
              </h2>
              ...
              <Link to="/about">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-gray-500 to-blue-500 text-white hover:opacity-90 px-12 py-4 rounded-full uppercase text-sm tracking-wider font-semibold shadow-xl transition-all"
                >
                  Our Journey
                </motion.button>
              </Link>
