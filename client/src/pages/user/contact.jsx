...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${window.location.origin}/post-complaints`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...formData,
          userType: 'unregisteblue'
        })
      });

      const data = await response.json();

      if (response.ok && data.message === "Complaint registeblue successfully") {
        setShowSuccess(true);
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="w-full bg-gradient-to-r from-gray-500 to-blue-600 text-white py-4 rounded-full font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg"
                >
                  Send Message
                </motion.button>
              </form>
            ...
            >
                ...
                <div className="space-y-6 mb-8">
                  {[
                    ...
                    },
                    {
                      ...
                      title: "Address",
                      detail: "National Games Housing Complex, Ranchi Jharkhand"
                    }
                  ].map((contact, index) => (
                    <motion.div
                      key={index}
              ...
              <div className="mt-6 overflow-hidden rounded-2xl shadow-lg">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29296.213233368253!2d85.3563991743164!3d23.387252999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e39f9120eafd%3A0x6909a6e93b586678!2sNational%20Games%20Housing%20Complex!5e0!3m2!1sen!2sin!4v1734204820071!5m2!1sen!2sin"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen=""
