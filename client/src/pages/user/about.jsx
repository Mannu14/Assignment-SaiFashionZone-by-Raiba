...
function About() {
  ...
  const SectionCard = ({ title, children, className = "", dataAos = "" }) => (
    <div
      data-aos={dataAos}
      className={`bg-white rounded-2xl p-8 transition-all duration-500 transform hover:scale-[1.02] hover:shadow-xl shadow-lg ${className}`}
      style={{
        background: "linear-gradient(145deg, #ffffff 0%,rgb(249, 177, 234) 100%)",
      }}
    >
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl font-extrabold mb-4">
              <span className="bg-gradient-to-r from-gray-500 to-blue-500 text-transparent bg-clip-text">
                About Our Company
              </span>
          ...
          <div className="text-center mt-16 bg-white rounded-2xl p-8 shadow-lg">
            <h2 className="text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-gray-500 to-purple-500 text-transparent bg-clip-text">
                Join Our Journey
              </span>
