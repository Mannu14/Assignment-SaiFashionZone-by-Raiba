...
const Sidebar = () => {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch(`${window.location.origin}/create-product`, {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            ...
            <button 
                ...
                className="fixed top-4 left-4 p-2 rounded-lg hover:bg-gray-200 lg:hidden z-50"
            >
                <Menu size={24} />
            </button>
                    ...
                    <div className="bg-white p-6 rounded-lg w-96">
                        ...
                        <div className="flex mb-3">
                            ...
                            <button
                                ...
                                className="w-1/3 bg-gray-500 text-white p-2 rounded-r"
                            >
                                Generate
                            </button>
                        </div>
            ...
            <div className={`fixed left-0 top-0 h-screen bg-gray-50 shadow-lg transition-all duration-300 flex flex-col 
                ...
                <div className="mt-auto">
                    <div className={`p-4 ${isOpen ? 'block' : 'hidden'}`}>
                        ...
                        <button 
                            ...
                            className="w-full bg-gray-300 text-white py-2 rounded hover:bg-gray-400 mb-2"
                        >
                            + Add Product
                        </button>
