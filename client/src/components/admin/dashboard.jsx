...
const Dashboard = () => {
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-red-50">
                <div className="text-center">
                    ...
                    <p className="text-red-600 text-xl">Loading Dashboard...</p>
                </div>
            </div>
        );
    }
    ...
    // Dashboard Render
    return (
        <div className="min-h-screen bg-red-100 p-6 lg:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    {[
                        ...
                        >
                            ...
                            <h3 className="text-red-500 text-sm mb-2">{metric.title}</h3>
